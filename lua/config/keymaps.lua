...
-- Persistence keymaps
map("n", "<leader>s", "<cmd>lua require('persistence').load()<cr>", { desc = "Load session", silent = true })
map("n", "<leader>l", "<cmd>lua require('persistence').load({ last = true })<cr>", { desc = "Load last session", silent = true })
